...
let {optionCtor, optionSpinner, loc_opt} = require("options_lib.nut")

let {
  MINIMUM, LOW, MEDIUM, HIGH, ULTRA, CUSTOM,
  graphicsPresetBlkPath,
  graphicsPresetUpdate,
  graphicsPreset
} = require("quality_preset_common.nut")
...
let mapOptionsByPreset = {
  ...
  [optScopeImageQuality]         = [0,       0,        1,        2,     3  ],
