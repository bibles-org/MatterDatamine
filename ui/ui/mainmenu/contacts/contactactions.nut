...
let {appId} = require("%ui/state/clientState.nut")
...
} = require("%ui/helpers/platformUtils.nut")
let { getContactRealnick } = require("%ui/mainMenu/contacts/contact.nut")
...
let { showUserInfo, canShowUserInfo } = require("%ui/mainMenu/contacts/showUserInfo.nut")
let { canCrossnetworkChatWithAll,
  canCrossnetworkChatWithFriends, crossnetworkPlay } = require("%ui/state/crossnetwork_state.nut")
let { removeNotifyById } = require("%ui/mainMenu/mailboxState.nut")
