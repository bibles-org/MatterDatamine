...
let { affectsWidget } = require("%ui/hud/player_info/affects_widget.nut")
let { mkHandStaminaComp, visibleHandStamina } = require("%ui/hud/player_info/hand_stamina.nut")
let { mkBreathUI, breathVisibleWatched } = require("%ui/hud/player_info/breath.nut")
let { mkHeartbeatUI } = require("%ui/hud/player_info/heartrate.nut")
