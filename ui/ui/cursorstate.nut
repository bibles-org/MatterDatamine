...
from "%ui/navState.nut" import doesNavSceneExist
...
let { showControlsMenu, showSettingsMenu } = require("%ui/mainMenu/menus/menuState.nut")
let { isLoggedIn } = require("%ui/login/login_state.nut")
let { navScenesListGen } = require("%ui/navState.nut")
let { freeCameraState } = require("%ui/freecamstate.nut")
let { editorIsActive, editorFreeCam } = require("%ui/editor.nut")
...
let showCursor = Computed(@()
  ...
  isCurrentMenuInteractive.get() || (editorIsActive.get() && !editorFreeCam.get()) ||
