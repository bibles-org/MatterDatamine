...
let {showHelp, editorIsActive, editorFreeCam, showLoadedScenes, showEntitySelect,
...
let loadedScenes = require("loadedScenes.nut")
...
return function() {
  ...
  return {
    ...
    children = [
      mainToolbar,
      (showLoadedScenes.value ? loadedScenes : null),
